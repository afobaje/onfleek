...
export default function StatisticsChart() {
  return (
    <div className='flex flex-col bg-card-bg p-5 rounded-3xl my-5 overflow-x-auto md:overflow-x-hidden'>
      <div className='flex justify-between mb-3'>
        <h2 className='font-semibold'>Statistics</h2>
        <select name="" id="" className='rounded-2xl p-1 outline-none text-theme-blue'>
